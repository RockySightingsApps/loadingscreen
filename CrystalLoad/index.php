...
<html>
	...
	<meta name="description" content="Welcome message" /> <!-- Webpage Description --> 
	<title>The Title</title> <!-- Webpage Title -->
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
        ...
        <img src="images/logo.png" width="400" height="192" alt="Your Logo" /><!-- This adds in the logo, simply change logo.png to make this look different -->
    	...
    	<div id="left-items"><!-- Opens the wrapper for the left content, there isn't really much to change on the left side as it's dynamic -->
            ...
            <div class="title server">
            	<h2>Marrannetworks</h2><!-- Adds in the server title, you can change the text to be whatever you would like -->
           	</div>
        ...
        <div id="right-items"><!-- Open wrapper for the items on the right -->
            ...
            <ul id="rules">
            	<li><span>1</span> Respect other players and staff.</li>
                <li><span>2</span> No prop abusing (flying, Attacking, blocking, pushing or random spawning of props).</li>
                <li><span>3</span> No changing job to gain access to supply or authority you would not normal have just to resupply yourself and teammates or to change the outcome of an ongoing crime.</li>
                <li><span>4</span> No Cheating, Glitching or Spamming</li>
                <li><span>5</span> No other Languages than Swedish and English</li>
                <li><span>6</span> NO RDM (Random Death Match)</li>
                <li><span>7</span> KOS (Kill on Sight) is allowed as soon as you put up a textscreen saying that its KOS. Otherwise its RDM.</li>
                <li><span>8</span> Follow the New Life Rule (NLR). NLR time is 1 Minute. Police and related can avoid NLR if someones wanted for example.</li>
                <li><span>9</span> Your base NEEDS to have atleast one entrance.</li>
                <li><span>10</span> This is not all the rules! Watch them by pressing "esc" and then "Rules"</li>
            </ul>
